...
registry.category("ir.actions.report handlers").add("euro_office-pdf_handler", async function (action, options, env) {
  if (action.report_type === "euro_office-pdf") {
